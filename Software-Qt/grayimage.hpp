...
template <typename Type>
void ImageProcessing::GrayImage<Type>::setGray(const LinAlg::Matrix<Type> &gray)
{
    this->gray = ImageProcessing::checkValue<Type>(gray);
...
ImageProcessing::GrayImage<Type> ImageProcessing::selfreinforceFilter(ImageProcessing::GrayImage<Type> GrayImage, const unsigned &sizeMask, const double &reinforceWeigth)
{
    ...
    GrayImage.setGray(ImageProcessing::checkValue(ImageProcessing::checkValue(reinforceWeigth*GrayImage.getGray()) - temp.getGray()));
    return GrayImage;
}
// fim Aula 13
